...
public class Day03BothParts {
	public static String path = "C:\\Users\\Smithers-HP\\Documents\\AdventOfCode\\Day3\\";

	public static void main(String args[]) throws FileNotFoundException {
		byte[][] data = new byte[1500][1500];
			...
			if (m.matches()) {
				out: for (int y = Integer.parseInt(m.group(3)); y < Integer.parseInt(m.group(3))
					...
					for (int x = Integer.parseInt(m.group(2)); x < Integer.parseInt(m.group(2))
						...
						if (data[x][y] != 2)
							break out;
						if (y == Integer.parseInt(m.group(3))
						+ Integer.parseInt(m.group(5)) - 1 && x == Integer.parseInt(m.group(2))
